...
class ObstacleAvoidanceNode(Node):
    ...
    def odom_callback(self, msg):
        ...
        # Verifica se uma nova zona foi detectada
    ...
    #Chama o sensor LiDAR para detectar obstáculos e controlar o movimento.    
    ...
    def stop_flag_callback(self, msg):
        ...
        if msg.data:  # Se a flag de parada for True
            self.get_logger().info("Encerrando a navegação.")
